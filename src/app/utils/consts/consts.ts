...
export enum testValues {
  ...
  AUTH_TOKEN_1 = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzAsImxvZ2luIjoicSIsImlhdCI6MTY0MzcyMDI2MywiZXhwIjoxNjQzNzM0NjYzfQ.dLUtDimhiSzrRaJvP10O6Dr-1V0TiGV5ddx6my-1lcY',

  LINK_1 = 'https://source.unsplash.com/user/c_v_r/1900x800',
  LINK_2 = 'https://picsum.photos/seed/picsum/200/300',
